...
import com.sskey.dms.model.EmployeeDTO;
...
//    private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //get preference
//        final String SDT = PreferenceUtils.getPhone(view.getContext());
//        final String Name = PreferenceUtils.getTenNguoiDung(view.getContext());
//        final String Mail = PreferenceUtils.getMailNguoiDung(view.getContext());
//        final String Address = PreferenceUtils.getDiaChiNguoiDung(view.getContext());
//        final String PassWord = PreferenceUtils.getPassword(view.getContext());
//        final String ID = PreferenceUtils.getMaNguoiDung(view.getContext());

        nguoiDung = UtilBasic.getUser(getContext());

        //set text
//        textUserName.setText(nguoiDung.getEmployee().getEmployeeName());
//        textPhoneUser.setText(nguoiDung.getEmployee().getTell());
//        textAddress.setText(nguoiDung.getEmployee().getAddress());

        textGmailUser.setText("");
        textPass.setText(nguoiDung.getPassWord());
        textUserName.setText(nguoiDung.getUserName());
            ...
            public void onClick(View v) {
                ...
                btn_save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        nguoiDung.setEmployee(new EmployeeDTO("",edt_name.getText().toString(),edt_address.getText().toString(),"",""));
                        nguoiDung.setPassWord(edt_pass.getText().toString());
                        ...
                        service.updateCustomer(nguoiDung).enqueue(new Callback<SucceedUpdate>() {
                            ...
                            public void onResponse(Call<SucceedUpdate> call, Response<SucceedUpdate> response) {
                                ...
                                if (response.message().equals("OK")) {
                                    ...
                                    PreferenceUtils.saveObj(UtilBasic.getGs().toJson(nguoiDung),getContext());
